...
mat4x2 m = mat4x2(_float_0_0);

void func0(int x)
{
 if(x < _int_1 || (x > _int_1 && one > _float_1_0))
  {
   return;
  }
 if(one == _float_1_0)
  {
   for(int i = _int_0; i < _int_2; i ++)
    {
     m[clamp(clamp(x, _int_0, _int_4 - _int_1), _int_0, _int_4 - _int_1)][clamp(i, _int_0, _int_2 - _int_1)] += _float_1_0;
    }
  }
}
void func1()
