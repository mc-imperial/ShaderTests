...
def main() -> None:
    ...
    tool.glsl_shader_job_crash_to_amber_script_for_google_cts(
        ...
        output_amber=bug_dir / "cov-clamp-vector-component-condition-using-matrix.amber",
        work_dir=bug_dir / "work",
        # One sentence, 58 characters max., no period, no line breaks.
        short_description="A fragment shader that covers specific patch optimization code paths",
