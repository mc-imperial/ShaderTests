...
void main()
{
 ...
 for(int i = _int_1; i < _int_10; i ++)
  {
   data[_GLF_MAKE_IN_BOUNDS_INT(i, 10)] = zero;
  }
 for(int i = 0; i < 9; i ++)
  {
   if(data[_GLF_MAKE_IN_BOUNDS_INT(i, 10)] < _float_1_0)
    {
     data[_GLF_MAKE_IN_BOUNDS_INT(i, 10)] = _float_2_0;
     break;
    }
  }
 if(data[_GLF_MAKE_IN_BOUNDS_INT(_int_0, 10)] == _float_1_0 && data[_GLF_MAKE_IN_BOUNDS_INT(_int_1, 10)] == _float_2_0 && data[_GLF_MAKE_IN_BOUNDS_INT(_int_2, 10)] == _float_0_0)
  {
