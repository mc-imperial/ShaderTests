...
#define _int_16 _GLF_uniform_int_values[3]
...
// Contents of _GLF_uniform_int_values: [1, 0, 10, 16]
...
const int _GLF_global_loop_bound = _int_10;

int _GLF_global_loop_count = _int_0;
...
void main()
{
 ...
 do
  {
   arr[_GLF_MAKE_IN_BOUNDS_INT(i ++, _int_16)] += float[5](_float_1_0, _float_2_0, _float_3_0, _float_4_0, _float_5_0)[usubBorrow(a, _uint_1, a)];
  }
 while(i < _int_10);
 if(arr[_GLF_MAKE_IN_BOUNDS_INT(_int_1, _int_16)] == _float_2_0)
  {
