...
; Schema: 0
          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpSource ESSL 320
               OpName %4 "main"
               OpName %7 "GLF_live10BST"
               OpMemberName %7 0 "data"
               OpMemberName %7 1 "leftIndex"
               OpMemberName %7 2 "rightIndex"
               OpName %13 "GLF_live10makeTreeNode(struct-GLF_live10BST-i1-i1-i11;i1;"
               OpName %11 "GLF_live10tree"
               OpName %12 "GLF_live10data"
               OpName %18 "GLF_live10insert(i1;i1;"
               OpName %16 "GLF_live10treeIndex"
               OpName %17 "GLF_live10data"
               OpName %25 "compute_value(f1;f1;"
               OpName %23 "limit"
               OpName %24 "thirty_two"
               OpName %31 "GLF_live10tree"
               OpName %39 "GLF_live10baseIndex"
               OpName %40 "GLF_live10_looplimiter0"
               OpName %65 "param"
               OpName %69 "param"
               OpName %76 "result"
               OpName %78 "i"
